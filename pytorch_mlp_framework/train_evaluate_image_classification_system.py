...
elif args.block_type == 'conv_block_with_batch_norm':
...
elif args.block_type == 'conv_block_batch_norm_with_res_conn':
    processing_block_type = ConvolutionalProcessingBlockBatchNormwithResConn
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlockwithBatchNorm
...
conv_experiment = ExperimentBuilder(network_model=custom_conv_net,
                                    ...
                                    test_data=test_data_loader,l_rate=args.l_rate)  # build an experiment object
