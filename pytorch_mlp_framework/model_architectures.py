...
class ConvolutionalProcessingBlockwithBatchNorm(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlockwithBatchNorm, self).__init__()
...
class ConvolutionalDimensionalityReductionBlockwithBatchNorm(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlockwithBatchNorm, self).__init__()
...
class ConvolutionalProcessingBlockBatchNormwithResConn(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlockBatchNormwithResConn, self).__init__()
